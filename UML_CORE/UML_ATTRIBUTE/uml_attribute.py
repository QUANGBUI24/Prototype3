...
def delete_attr(class_name: str, attr_name: str):
    ...
    is_chosen_yes = user_choice(
        f"delete attribute '{attr_name}' from class '{class_name}'"
    )
    if not is_chosen_yes:
        return
    ...
    # Print successful message
    print(
        f"Attribute '{attr_name}' was successfully deleted from class '{class_name}'!"
    )
...
def rename_attr(class_name: str, old_attr_name: str, new_attr_name: str):
    ...
    is_chosen_yes = user_choice(
        f"rename attribute name '{old_attr_name}' to attribute name '{new_attr_name}' from class '{class_name}'"
    )
    if not is_chosen_yes:
        return
    ...
    # Print successful message
    print(
        f"Attribute '{old_attr_name}' was renamed to '{new_attr_name}' in class '{class_name}'!"
    )
...
def check_attr_name(
    attr_list: str, attr_name: str, class_name: str, should_exist: bool
) -> bool:
